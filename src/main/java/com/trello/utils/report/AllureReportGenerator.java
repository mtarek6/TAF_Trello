package com.trello.utils.report;

import com.trello.utils.OSUtils;
import com.trello.utils.TerminalUtils;
...
import static com.trello.utils.dataReader.PropertyReader.getProperty;
import static com.trello.utils.report.AllureConstants.HISTORY_FOLDER;
import static com.trello.utils.report.AllureConstants.RESULTS_HISTORY_FOLDER;
...
public class AllureReportGenerator {
    ...
    public static String renameReport() {
        ...
        com.trello.FileUtils.renameFile(AllureConstants.REPORT_PATH.resolve(AllureConstants.INDEX_HTML).toString(), newFileName);
        return newFileName;
    }
